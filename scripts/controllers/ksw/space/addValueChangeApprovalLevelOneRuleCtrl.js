...
(function () {
    angular.module("app")
        .controller("addValueChangeApprovalLevelOneRuleCtrl", ["$scope", "$stateParams", "SpaceService", "LoggerService", "$rootScope", "$mdDialog", "$state",
            function ($scope, $stateParams, SpaceService, LoggerService, $rootScope, $mdDialog, $state) {
                ...
                $scope.applyRule = function(){
                    var inputSetValues = [
                        {
                            name: "RequiredNumber",
                            value: $scope.inputSet.requiredNumber
                        },
                        {
                            name: "DueDate",
