...
(function () {
    angular.module("app")
        .controller("treeLayoutCtrl", ["$scope", "$stateParams", "SpaceService", "LoggerService", "GraphDataParseService",
            function ($scope, $stateParams, SpaceService, LoggerService, GraphDataParseService) {
                ...
                SpaceService.getRelatedNeighboursWithRelation(spaceId)
                    .then(function (response) {
                       // LoggerService.log('getRelatedNeighboursWithRelation');
                        //LoggerService.log(GraphDataParseService.getParsedData(response.data.data));
                        var params = GraphDataParseService.getParsedData(response.data.data);
                        entityGraphTreeLayout(params);
                    });
                ...
                function entityGraphTreeLayout(params) {
                    console.log(params);
                    ...
                    var svg = d3.select("#relationGraphContainer").append("svg")
